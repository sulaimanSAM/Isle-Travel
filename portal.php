...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo validate_image('uploads\slider1.jpg'); ?>" alt="Slide 1" style="width:100%;">
        </div>

        <div class="carousel-item">
            <img src="<?php echo validate_image('uploads\slider2.jpg'); ?>" alt="Slide 2" style="width:100%;">
        </div>

        <div class="carousel-item">
            <img src="<?php echo validate_image('uploads\slider3.jpg'); ?>" alt="Slide 3" style="width:100%;">
        </div>
    </div>
...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Welcome ISLE Travels</div>
...
<section class="page-section bg-dark" id="home">
	...
	<div class="row">
		<?php
		$hotel = $conn->query("SELECT * FROM `hotel` order by rand() limit 3");
			while($row = $hotel->fetch_assoc() ):
				...
				$review = $conn->query("SELECT * FROM `rate_review` where id='{$row['id']}'");
				$review_count =$review->num_rows;
				$rate = 0;
				while($r= $review->fetch_assoc()){
					$rate += $r['rate'];
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=hotel" class="btn btn-flat btn-warning mr-4">Explore Hotels <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
