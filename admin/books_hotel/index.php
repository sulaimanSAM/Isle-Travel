	...
	<div class="card-body">
        ...
        <table class="table table-stripped text-dark">
            ...
            <tbody>
                <?php 
                $i=1;
                    $qry = $conn->query("SELECT b.*,p.title,concat(u.firstname,' ',u.lastname) as name FROM book_list b inner join `hotel` p on p.id = b.hotel_id inner join users u on u.id = b.user_id order by date(b.date_created) desc ");
